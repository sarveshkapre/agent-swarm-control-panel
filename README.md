...
## Status
MVP UI with approvals drawer, policy editor, log filters/pinning, growth momentum dashboard, run health summary, and local state import/export. No authentication (local-only).
